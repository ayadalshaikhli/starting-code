      ...
      <div className="shipping__details text-left ">
        <div className="shipping__info flex pb-3">
          ...
          <p className="p-10 w-1/2">
            ...
            why we provide free shipping from our warehouses in Asia by EMS and
            in the USA by USPS.
          </p>
        </div>
        <div className="shipping__info flex">
          ...
          <p className="p-10 w-1/2">
            ...
            be from one of those countries we will contact you.
          </p>
        </div>
        <div className="shipping__info flex">
          <h1 className="p-10 font-bold w-1/4">LOST/MISSING PACKAGES</h1>
          <p className="p-10 w-1/2">
            TatoMaange are not liable if the incorrect address is placed during
            the checkout process. Please make sure that your billing and
            shipping address is correct before processing your order. If we have
            made an error we will fully take responsibility of the original
            order that was made for you at no charge.
          </p>
        </div>
        <div className="shipping__info flex">
        ...
        <div className="shipping__info flex">
          ...
          <div className="p-10 w-1/2">
            <h1>Shipping time varies by location. These are our estimates:</h1>
        ...
        <div className="shipping__info flex">
          ...
          <p className="p-10 w-1/2">
            You will receive an email with a tracking number once your order is
            shipped but sometimes due to free shipping tracking is not
            available. MY TRACKING SAYS “NO INFORMATION AVAILABLE AT THE
            MOMENT”. For some shipping companies, it takes 2-5 business days for
            the tracking information to update on the system. If your order was
        ...
        <div className="shipping__info flex">
          ...
          <p className="p-10 w-1/2">
            ...
            shipping. If you have any other questions, please contact us and we
